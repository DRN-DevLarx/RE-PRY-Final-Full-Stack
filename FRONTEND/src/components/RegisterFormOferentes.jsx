...
function RegisterForm1() {
  ...
  function btnSiguiente2() {
    ...
    if( Nombre === "" || Apellido === "" || Usuario === "" || Telefono === "" || Correo === "" || Fecha_Nacimiento === "" || contraseña === "" || Confirm_Contraseña === "") {
      ...
      //   Swal.fire({
      //     icon: "error",
      //     text: `El campo ${palabrasProhibidas[p]} no está permitido.`,
      //     confirmButtonColor: "#2ae2b6",
      //     background: "#1a1a1a",
      //     color: "#ffffff",
      //     confirmButtonText: "Aceptar",
  ...
  return (
    <div id='bodyRegister'>
      ...
      <div id='contRegister'>
        ...
        <div id='btnsRegister'>
          <button className='btnROferenteE'> <Link className="LinkRegister" to="/register1">Persona oferente</Link> </button>
      ...
      {Contenedor3 && (
        <div id='contRegister'>
          ...
          <div className='DIVbtnR'>
            <button className='btnNextRegister' onClick={btnIniciarSesion} >Iniciar sesión</button>
          </div>
        </div>
      )}
