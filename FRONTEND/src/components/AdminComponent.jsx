...
function AdminComponent() {
  return (
    <div id='contbodyadmin'>
      ...
      <div className="cuadrosGrid">
        <div className="cuadro">Cuadro 1</div>


        
        <div className="cuadro">Cuadro 2</div>
        <div className="cuadro">Cuadro 3</div>
        <div className="cuadro">Cuadro 4</div>
        <div className="cuadro">Cuadro 5</div>
        <div className="cuadro">Cuadro 6</div>
      </div>
